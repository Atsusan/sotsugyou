      ...
      <div class="inner">
        <div class="download-flex">
          <div class="download-item">
            <h2 class="download-item-title wow fadeInUp">世界で活躍できるグローバルな人材を育てる３つの研修プログラムをご用意しております。</h2><!-- /.download-item-title -->
          ...
          <div class="download-form">
            <h2 class="download-form-title wow fadeInUp">資料ダウンロード</h2><!-- /.download-form-title -->
