                    ...
                    <section class="cases-section">
                        ...
                        <article class="cases-items">
                            <div class="cases-item">
                                ...
                                <div class="cases-item-body">
                                    <h3 class="cases-item-title">研修コース：<span class="cases-item-title-span">異文化コミュニケーション</span></h3>
                                    <!-- /.cases-item-title -->
                                    <ul class="cases-item-lists">
                                        <li class="cases-item-list">
                                            <h4 class="cases-item-list-title">研修の目的</h4><!-- /.cases-item-list-title -->
                    ...
                    <section class="cases-section">
                        ...
                        <article class="cases-items">
                            <div class="cases-item">
                                ...
                                <div class="cases-item-body">
                                    <h3 class="cases-item-title">研修コース：<span class="cases-item-title-span">ビジネス留学プログラム</span></h3><!-- /.cases-item-title -->
                                    <ul class="cases-item-lists">
                                        <li class="cases-item-list">
                                            <h4 class="cases-item-list-title">研修の目的</h4><!-- /.cases-item-list-title -->
                                            <p class="cases-item-list-text">
